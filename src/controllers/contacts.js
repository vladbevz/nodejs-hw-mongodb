...
export const createContact = async (req, res, next) => {
    try {
        ...
        if (!name || !phoneNumber || !contactType) {
            throw httpErrors(400, "Missing required fields: name, phoneNumber, or contactType");
        }
...
export const patchContact = async (req, res, next) => {
    ...
    try {
        ...
        const updatedContact = await contactServices.updateContact(contactId, { name, phoneNumber, email, isFavourite, contactType });
